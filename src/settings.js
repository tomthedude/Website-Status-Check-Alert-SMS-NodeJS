...
module.exports = {
  ...
  WEBSITES_FROM_FILE: process.env.WEBSITES_FROM_FILE,
  TERMINAL_ALL_RESULTS_INTERVAL: process.env.TERMINAL_ALL_RESULTS_INTERVAL,
  RESULTS_FOLDER: process.env.RESULTS_FOLDER,
  FRON_END_FOLDER: process.env.FRON_END_FOLDER,
};
